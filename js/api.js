...
const token = '07a450a7ad184c4c86138275c04878cc';
const liga = 2015;
const ligabundes = 2018;

let liga_standing =       `${base_url}competitions/${liga}/standings`;
let ligabundes_standing = `${base_url}competitions/${ligabundes}/standings`;
